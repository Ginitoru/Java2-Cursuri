...
public class ComandaServiceImpl extends UnicastRemoteObject implements ComandaService {
    ...
    public ComandaServiceImpl() throws RemoteException {
        var emf = Persistence.createEntityManagerFactory("xxx");
    ...
    @Override
    public void persists(ComandaDto comandaDto) throws RemoteException {
    ...
    public Collection<ComandaDto> findByProdusId(int produsId) throws RemoteException {
       ...
       return comandaDao.findByProdus(produsId).stream()
