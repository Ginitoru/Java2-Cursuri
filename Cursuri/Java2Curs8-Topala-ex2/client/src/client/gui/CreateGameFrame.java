...
import client.listener.DispecerService;
...
public class CreateGameFrame extends JFrame implements JoinEventListener {
    ...
    public CreateGameFrame(){
        ...
        incepeJocButton.addActionListener(ev -> {
           ...
           //todo: deschdie fereastra cu intrbarea curenta

            new MainFrame();


            DispecerService.getInstance(gameId)
                    .removeListener(this);
        ...
        DispecerService.getInstance(gameId).addListener(this);
