...
public class GameServiceImpl extends UnicastRemoteObject implements GameService {
    ...
    public Question startGame(String gameId) throws RemoteException {
       Question nextQuestion =  gameRepository.getCurrentQuestion(gameId);
    ...
    @Override
    public Question nextQuestion(String id) throws RemoteException {
        notifyForGame(id);


        return gameRepository.getNextQuestion(id);
    }
